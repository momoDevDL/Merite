  ...
  <div class="dashboard">
    ...
    <div :class="{ openned: sidebar }" class="sidebar">
      ...
      <div class="sidebar-menu ">
        ...
        <nuxt-link
          :class="{ active: this.$route.path.includes('/admin/utilisateurs') }"
          @click.native="changeSelectedLink"
          num="2"
    ...
    <div :class="{ openned: sidebar }" class="navbar-dashboard">
      <div class="navbar-dashboard-left">
        ...
        <div class="hello-dashboard">
          <h1 v-if="$route.path == '/admin/'" class="dashboard-title">
            Gérez le <span class="dashboard-title-accent">site</span>
          </h1>
          <h1
            v-if="$route.path == '/admin/utilisateurs'"
            class="dashboard-title"
          >
            Gérez vos <span class="dashboard-title-accent">utilisateurs</span>
          </h1>
          <h1
            v-if="$route.path == '/admin/utilisateurs/ajouterUtilisateur'"
            class="dashboard-title"
          >
            Ajouter un <span class="dashboard-title-accent">utilisateur</span>
          </h1>
          <h1
            v-if="$route.path == '/admin/utilisateurs/modifierUtilisateur'"
            class="dashboard-title"
          >
      ...
      <div class="navbar-dashboard-right">
        <button @click="logout" class="btn-deco-dashboard">Déconnexion</button>
      </div>
    </div>
...
.navbar-dashboard {
  ...
  .btn-deco-dashboard {
    ...
    border-radius: 8px;
    border: none;
    box-shadow: 0px 4px 15px rgba(39, 24, 252, 0.3);
    transition: 0.3s;

    &:hover {
      box-shadow: 0px 4px 4px rgba(39, 24, 252, 0.3);
