...
export function refresh(req, res) {
    ...
    if (!UserAccesToken) {
        ...
        try {
            verifiedTokenPayload = jwt.verify(
                UserAccesToken,
            ...
            return res
                .status(401)
                .send(
                    "Failed to match Access Token the payload has been tampered with"
                );
        }
        ...
        models.User
            ...
            .catch((error) => {
                return res
                    .status(500)
                    .send("DB request failed could not retrieve refresh token");
            });
