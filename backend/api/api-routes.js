...
const { getCourse, addCourse, deleteCourse, editCourse, asignStudentsToCourse, getUserCourses, changeFavoriteState, getFavoriteCourses } = require('./Controller/courseController');
...
router.route('/course/favorite')
    .put(verifyToken, changeFavoriteState)
